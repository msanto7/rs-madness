...
public static class TeamSeeder
{
    public static async Task SeedTeamsAsync(AppDbContext db)
    {
        ...
        var teams = new List<Team>
        {
            ...
            new() { Name = "Ohio St.", Seed = 8, Region = "East" },
            ...
            new() { Name = "North Dakota St.", Seed = 14, Region = "East" },
            ...
            new() { Name = "Miami (FL)", Seed = 7, Region = "West" },
            new() { Name = "Missouri", Seed = 10, Region = "West" },
            new() { Name = "Purdue", Seed = 2, Region = "West" },
            new() { Name = "Queens (NC)", Seed = 15, Region = "West" },
            ...
            new() { Name = "Iowa St.", Seed = 2, Region = "Midwest" },
